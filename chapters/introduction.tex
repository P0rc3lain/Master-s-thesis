...
Termin oznacza, że stworzenie obrazu z modelem reprezentowanym w finalnej formie potrzebuje uruchomienie potoku dokładnie jeden raz.
Współcześnie tego rodzaju podejście jest rzadko stosowane.
Wynika to zarówno z wynalezienia bardziej efektywnych sposobów renderowania - poprzez zwiększenie ilości wywołania potoku z mniej wymagającymi obliczeniami, co charakteryzuje się wyższą wydajnością.
Dodatkowo, chęć polepszenia walorów wizualnych wymaga generowania dodatkowych, tymczasowych klatek pośrednich.
W efekcie okazuje się, że stworzenie pojedynczego wycinka animacji wymaga dziesiątek wywołań potoku.
