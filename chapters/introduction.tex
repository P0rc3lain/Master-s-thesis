...
Dodatkowo, jeżeli uprzednio obraz wyjściowy posiadał dla zadanego piksela dane odnoszące się do innego trójkąta następuje sprawdzenie, czy piksel powinien zostać zaktualizowany.
Decyzja podejmowana jest na podstawie odległości fragmentu od kamery. 
Jako aktualny przyjmowany jest ten, który znajduje się bliżej, a więc nieprzesłonięty przez inny.
\begin{figure}[H]
    \begin{center}
...
\end{figure}
\paragraph*{Fragment Function}
\paragraph*{Scissor}
\paragraph*{Multisample}
\paragraph*{Stencil Test}
\paragraph*{Depth Test}
\paragraph*{Visibility Result}
\paragraph*{Blend}
