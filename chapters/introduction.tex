...
Produkt jest skrojony pod uprzednio określone zasoby, a w sytuacji gdy dany efekt skutkuje w spadkach wydajności jest usuwany.
Z drugiej strony branża filmowa kładzie nacisk na jakość.
Odbiorca nie ma wpływu na wydarzenia, odtwarzana animacja za każdym razem wyglądać będzie w ten sam sposób.
Restrykcja czasowa, której podlega generowanie kolejnych klatek jest praktycznie zaniedbywalna.
Generowanie kolejnych fragmentów animacji wystarczająco szybko, aby ludzkie oko postrzegało proces jako płynny, nieprzerwany, przy jednoczesnym zapewnieniu wpływu na przedstawione wydarzenia nazywamy grafiką czasu rzeczywistego.
...
Klatka rozumiana powinna być jako pojedynczy obraz dwuwymiarowy przedstawiający punkt animacji.
Jako minimalny próg ilości w ciągu sekundy przyjmuje się często 30 klatek.
Słowo interaktywność jest kluczem odróżniającym grafikę czasu rzeczywistego od nierzeczywistego.
...
Urządzenia spełniające tę role nazywane są GPU \normalfont{\textit{(ang. graphics processing unit)}}.
...
Pierwsze API \normalfont{\textit{(ang. application programming interface)}} realizowały stosunkowo szeroki zakres funkcjonalności.
