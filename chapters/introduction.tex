...
Choć producenci stosują różne architektury to API sprawia, że różnice te mogą być dla twórców oprogramowania zaniedbywalne.
Pełne uspójnienie interfejsu jest niemożliwe, ze względu na występujące sprzętowe różnice, jednak w znacznej mierze dostępne instrukcje stanowiące trzon nie podlegają zmianom.
\par 
Używane obecnie technologie opisywane są jako niskopoziomowe.
W odróżnieniu od koncepcji przypadających na pierwsze lata rozwoju pomysłu współcześnie użytkownicy operują na buforach, programach cieniujących czy kolejkach komend zamiast pierwotnych, wysokopoziomowych rozkazów dotyczących zarządzania sceną.
...
Może zostać opisany następujących algorytmem:
\begin{enumerate}
    \item Inicjalizacja API
    \item Wczytywanie asetów
    \item Aktualizacja asetów
    \item Prezentacja
    \item Powtórzenie kroków 2, 3 oraz 4 do momentu sygnału zatrzymania programu
    \item Destrukcja
\end{enumerate}
...
Jeśli jednostka graficzna obsługuje technologię API, wówczas zakładając posiadanie podstawowych narzędzi developerskich można jej użyć.
