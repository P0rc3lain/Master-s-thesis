...
Asynchroniczna natura wykonywania operacji na GPU i chęć minimalizacji ilości synchronizacji pomiędzy GPU i SPU sprawia, że wszystkie nowoczesne API kolejkują zadania i wysyłają je batchach.
\subsection{DirectX, OpenGL, Vulkan}
% Napisać, że w zasadzie to są najpopularniejsze API
% Napisać, że DirectX został zmodernizowany w celu użycia nowego podejścia
% Wspomnieć, że OpenGL zostało porzucone na rzecz vulkana.
% Powiedzieć, ze w zasadzie te rozwiązania są nieobecne na platformie apple
\subsection{Metal}
% Napisz, że w sumie często ludzie korzystają z Vulkana - bo otwiera im to drogę na linuxa i windowsa.
...
% Napisz, że w zasadzie nafajniejsze jest to, że Metal to tak naprawdę okrojone C++14
