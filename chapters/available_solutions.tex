...
Wśród wielu twórców przywołać można kanały takie jak ThinMatrix czy TheCherno ponieważ są one nadwyraz rozpoznawalne wśród entuzjastów grafiki komputerowej.
\par
...
% Napisać jaka w ogóle jest grupa odbiorców silnika, do jakich produkcji śa skierowane
...
\section{Pozostałe silniki}
% Napisz o jmonkey, urho3d, Amazon Lumberyard, panda 3d
