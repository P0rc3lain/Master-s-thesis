...
Przejście z jednego pola do innego wykorzystuje ten sam efekt.
...
Każdy z nich jest od siebie niezależny.
...
\code{Swift}
     {Struktura przechowująca obecny stan rozgrywki}
...
\code{Swift}
     {Funkcja realizująca wczytywanie modeli}
...
\code{Swift}
     {Logika przetwarzania interakcji}
