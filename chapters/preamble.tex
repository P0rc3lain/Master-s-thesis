...
Za cel pracy obrano stworzenie natywnej biblioteki do generowania grafiki czasu rzeczywistego.
Projekt pomagał będzie zaimplementować proste gra oraz wzbogacić szeroko rozumiane aplikacje użytkowe o warstwę trójwymiarową.
Gama wspieranych urządzeń obejmowała będzie systemy z ekosystemu Apple takie jak macOS, iOS oraz tvOS.
...
Logika renderowania wraz ze wszystkimi pośrednimi krokami stworzonymi na potrzeby potoku pozostanie niewidoczna, podlegać będzie jednak konfiguracji.
\par
