...
Głównie za sprawą faktu, że prawa do technologii spoczywały w rękach Apple.
...
Kluczowe cechy były bezpośrednią odpowiedzią na zarzuty w stosunku do bolączek Objective-C.
\par
...
W rezultacie Swift zagościł na systemach Linux oraz Windows, a przypadek użycia zawiera nie tylko tworzenie aplikacji dla urządzeń Apple, ale język traktowany jest jako rozsądna technologio serwerowych.
Chciało zerwać z dotychczasowym wizerunkiem, który obecny był w Objective-C.
...
W tym znaczeniu należy rozpatrywać łatwość w rozumieniu jako ekspresyjność.
...
W większości przypadków są one stanowe \longpause zmiana dokonana na jednym z ekranów wpływa na inny lub pozostałą funkcjonalność.
...
% Napisz, że dokumentacja jest ustardyzowana
