...
\subsection{C++}
Decyzję o stworzeniu rozszerzenia do języka C motywowano chęcią otworzenia się na paradygmat programowania obiektowego.
Dzieło Bjarne Stroustrup'a zachowywało wszystkie dotychczasowe korzyści wynikające z użycia niskopoziomowego języka, ale sprawiało, że programiści byli w stanie otworzyć się na projektowanie elastycznej architektury.
...
\par
Jego mocną stroną jest mnogość wspieranych platform.
...
Dzięki temu obydwa z nich mają niewielki narzut wydajnościowy w stosunku do języka maszynowego.
Przez wzgląd na wbudowane w kompilator algorytmy do optymalizacji wysoce prawdopodobnym jest, że kod C++ będzie lepszy niż równoważny odpowiednik napisany przez przeciętnego człowieka, bezpośrednio w formie zrozumiałej dla komputera.
