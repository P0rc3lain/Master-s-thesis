...
Producent aktywnie rozwija system, dostarcza komponenty w oparciu o które można budować aplikacje, ale długi czas pozostawiał społeczności projektowanie i rozwój bibliotek ułatwiających pracę w specyficznych dziedzinach.
W przypadku chęci stworzenia gry dwu lub trzy wymiarowej producent sugerował skorzystanie wprost z API graficznego i własnego rozwiązania.
...
Wiedziano, że bez wsparcia wiele aplikacji ominie platformę lub nawet doprowadzi do migracji użytkowników na konkurencyjny iOS.
...
\par
Projekt posiada wsparcie dla szeregu systemów, ale największy nacisk położony jest na środowisko Android.
...
Sam projekt publicznych części biblioteki pokrywa się z schematami powszechnie przyjętymi w Androidzie.
\par
...
% dokumentacja jest super
% nastawiony jest na poprawne działanie w systemie andorid
% Nie ma silnika fizycznego
