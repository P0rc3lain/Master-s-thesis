...
Wspomnianym trendem tak - jak wyjaśniono we wprowadzeniu - jest chęć oddania możliwie jak najniżejpoziomowo sposób w który operują jednostki graficzne.
...
Pomimo popularności na innych platformach najświeższy otwarty standard graficzny opublikowany przez grupę Khronos - Vulkan - pozostaje niedostępny.
\subsection{OpenGL}
...
W jego przypadku skorzystać można tylko i wyłącznie ze stosunkowo wysokopoziomowyej biblioteki do rysowania - Core Graphics.
