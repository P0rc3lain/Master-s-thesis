...
Dostępny jest na większości platform, zarówno mobilnych, jak i stacjonarnych, ale w głównej mierze przeznaczony jest do mniej złożonych produktów.
\par
Rozwiązanie należy zaliczyć do płatnych, choć rozwój aplikacji wykorzystującej technologię można rozpocząć bezpłatnie.
Jednak myśląc o wydaniu komercyjnie rentownej aplikacji dostrzec można mnogość ograniczeń.
...
\par
Choć rozwijany jest w języku C++ to interakcja odbywa się za pomocą C\#.
...
Mono \longpause framework wykorzystywany przez Unity w tym celu \longpause ma pewne mankamenty.
Przede wszystkim użytkownicy narzekają na okazjonalne przycięcia w grach wynikające ze specyfiki zarządzania pamięcią.
Zastanawia sama obecność C\#.
...
Na obronę przyznać należy, że grę w Unity można stworzyć bez znajomości platformy docelowej.
\par
...
\par
Pomimo ciągłego rozwoju Unity jego grafika wydaje się odstawać od konkurencji.
Podkreślić należy, że potok renderowania silnika jest konfigurowalny, więc jeśli jakość dla odbiorcy jest niezadowalająca istnieje możliwość dokonania korekcji we własnym zakresie.
Otwiera to możliwość stworzenia zupełnie unikalnego stylu graficznego, choć zaakceptować należy wysoki poziom wymaganej wiedzy do osiągnięcia tego celu.
\par
...
Koncept miał za zadanie otworzyć silnik na szersze grono odbiorców i zaoferować możliwość tworzenia gier niebędącym zaznajomionym z programowaniem.
Pozornie pomysł wydaje się oszczędzać czas i ułatwiać rozwój, mimo to odsetek osób korzystających z rozwiązania jest niewielki.
...
\par
Za minus uznać należy narzut w kwestii wagi aplikacji.
...
\fig{images/engines/unity/example-game.png}
