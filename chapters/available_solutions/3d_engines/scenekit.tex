...
Choć jej interfejs ewoluował i rozrastał się w miarę upływu lat to założenia projektu pozostały niezmienione.
2015 był rokiem kiedy podczas konferencji WWDC Apple zaprezentowało koncepcje sugerujące programistom języka Swift podejście oparte o komunikacje zorganizowaną wokół protokołów.
W głównej mierze uogólnić można je na zestaw sugestii sprawiających, że kod będzie reużywalny, testowalny oraz przejrzysty.
...
Od tamtego czasu użytkownicy nie otrzymali żadnych poprawek, ani stanowiska Apple określającego przyszłość.
...
Przyznać należy, że w sieci dostępnych jest wiele przykładów demonstrujących działanie.
