...
\par
Choć wspierany jest szereg systemów, jednakże największy nacisk położony jest na Android.
...
Dziwi, że Google wprawdzie umiejscowiło repozytorium pod skrzydłami swojej organizacji, ale zaznacza, że nie jest on oficjalnie wspierany.
\par
...
Jest ich kilka, w formie przykładów wprowadzających dla każdej z platform.
