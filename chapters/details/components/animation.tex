...
\lstinputlisting[language=Swift, caption=Struktura przechowująca animację poklatkową]
...
\lstinputlisting[language=Swift, caption=Interfejs służący do obsługi animacji]
...
\end{figure}
\lstinputlisting[language=Swift, caption=Interfejs samplera]
...
\lstinputlisting[language=Swift, caption=Definicja szkieletu modelu]
