...
\lstinputlisting[language=Swift, caption=Interfejs służący do obsługi animacji]{code/animation/PNKeyframeAnimation_short.swift}
\par
...
\lstinputlisting[language=Swift, caption=Interfejs służący do obsługi animacji]{code/animation/PNAnimator.swift}
\par
...
\end{figure}
\lstinputlisting[language=Swift, caption=Interfejs samplera]{code/animation/PNSampleProvider.swift}
...
\lstinputlisting[language=Swift, caption=Definicja szkieletu modelu]{code/PNSkeleton.swift}
\par
...
Wspomnieć można, że szkielet opisany jest za pomocą tablicy składającej się z lokalnych transformacji dla każdej z kości.
...
List zawierające aktualne transformacje kości przekazywana jest do programu cieniującego gdzie obliczana jest finalna pozycja wierzchołków.
