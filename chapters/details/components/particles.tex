...
\lstinputlisting[language=Swift, caption=Struktura cząsteczki]{code/PNParticle.swift}
\par
...
\lstinputlisting[language=Swift, caption=Zasady wytwarzania cząsteczek]{code/PNEmissonRules.swift}
\par
Zasady wykorzystywane są przez pochodne interfejsu \textit{PNEmitter}, które na ich podstawie tworzą nowe cząsteczki.
\lstinputlisting[language=Swift, caption=Emitter cząsteczek]{code/PNEmitter.swift}
\par
...
\lstinputlisting[language=Swift, caption=Kontroler zachowania cząsteczek]{code/PNParticleController.swift}
\par
...
\lstinputlisting[language=Swift, caption=Interfejs do pozyskiwania renderowalnych cząsteczek]{code/PNRenderableParticlesProvider.swift}
\par
