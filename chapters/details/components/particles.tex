...
Dodatkowo, kontroler odpowiedzialny jest za aktualizacje parametrów cząsteczek.
\code{Swift}
     {Kontroler zachowania cząsteczek}
...
\code{Swift}
     {Interfejs do pozyskiwania renderowalnych cząsteczek}
