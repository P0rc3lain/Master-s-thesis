...
\subsection{Światła}
Zgodnie z tym co wyjaśniono w poprzedniej sekcji biblioteka wspiera trzy podstawowe emitery światła.
Są tą źródła kierunkowe (imitujące słońce), punktowe (żarówki) oraz punktowo-kierunkowe (latarki, reflektory samochodów).
...
\lstinputlisting[language=Swift, caption=Protokół światła kierunkowego]
                {code/lights/PNDirectionalLight.swift}
\par
...
\lstinputlisting[language=Swift, caption=Interfejs źródła ambientowego]
                {code/lights/PNAmbientLight.swift}