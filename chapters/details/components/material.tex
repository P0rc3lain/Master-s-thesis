...
Choć parametry te przechowywane są w formie obrazu to użytkownikowi oddano metody, które na podstawie pojedynczej wartości przygotują jednolitą mapę.
...
\lstinputlisting[language=Swift, caption=Definicja materiału]
                {code/PNMaterial.swift}
