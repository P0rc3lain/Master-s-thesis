...
\section{Jakość}
Systematyczny rozwój kolejnych modułów biblioteki bezpośrednio wpływał na zwiększanie się jego objętości.
...
Największą popularnością cieszy się technologia przedstawiona przez Google \longpause \textit{Amber}~\cite{google_amber} \longpause jednak nie wspiera on platformy Apple.
