...
Uwzględnienie sugestii nie tylko sprawia, że kod staje się spójny wewnętrznie, ale także z innymi publicznymi projektami aplikującymi podejście.
\par
...
Sprawdzono nim również same konfiguracje linterów, które zachowane zostały w głównym katalogu projektu.
...
Największą popularnością cieszy się projekt przedstawiony przez Google \longpause \textit{Amber}~\cite{google_amber} \longpause jednak nie wspiera on platformy Apple.
