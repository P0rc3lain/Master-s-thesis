...
Dodatkowo, dane, które zmieniają się w czasie, jak pozycje czy właściwości świateł, przekazywane są do \textit{PNIBufferStore}, gdzie następuje synchronizacja pomiędzy pamięcią RAM CPU, a GPU.
\par
...
\par
Etapy - klasy implementujące interfejs \textit{Stage}, mające adekwatny przyrostek w nazwie - opierają się podobnie jak klasa potoku na nieskomplikowanej idei.
...
\lstinputlisting[language=Swift, caption=Logika renderowania wykorzystywana w klasach pochdnych \textit{PNRenderJob}]
