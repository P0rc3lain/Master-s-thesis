...
Na etapie projektowania należało podjąć decyzję który z nich wykorzystać do wykonania biblioteki.
...
Między innymi styl programistyczny wymuszony przez zasady sprawia, że kod w różnych obszarach aplikacji jest do siebie podobny.
...
W sieci znaleźć można biblioteki takie jak Swiftz czy swift-overture wychodzące naprzeciw w kwestii problemu.
...
Programowanie funkcyjne wśród technologii obecnych w Swift jest ciekawostką.
...
Z tego względu konicznym będzie oddać możliwość integracji z biblioteką reaktywną Combine gdzie to możliwe.
\par
W większości rozwiązań rozważania na temat ogólnego podejścia można byłoby zakończyć po powyższym opisie.
Chęć renderowania grafiki wymaga uwzględnienia specyfiki działania karty graficznej w celu uzyskania optymalnej wydajności.
...
Zdecydowano się oprzeć o nie część biblioteki odpowiedzialnej za renderowanie obrazu.
