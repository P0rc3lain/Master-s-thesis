...
Metal nie jest kompatybilny ze Swift, w celu przesłania danych producent w przykładach stosuje oddzielną deklarację dla każdego z języków.
...
W następnym kroku nagłówki C grupowane są w moduły udostępnione przez kompilator XCode do kodu Swift.
...
Dodatkowo, standard Swift nie daje gwarancji w kwestii uporządkowania pól dla struktury, co jest kluczowe w celu właściwej interpretacji danych.
\code{C}
