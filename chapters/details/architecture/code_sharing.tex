...
\lstinputlisting[language=C, caption=Definicja struktury w języku C]
                {code/code_sharing/Camera.h}
\lstinputlisting[language=Swift, caption=Deklaracja modułu Swift składającego się z kodu C]
                {code/code_sharing/module.map}
\lstinputlisting[language=Swift, caption=Użycie modułu w kodzie Swift]
