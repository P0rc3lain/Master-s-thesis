...
\lstinputlisting[language=C++, caption=s]{code/code_sharing/Camera.h}
\lstinputlisting[language=C++, caption=Przykład kodu w języku C++]{code/code_sharing/module.map}
\lstinputlisting[language=C++, caption=Przykład kodu w języku C++]{code/code_sharing/PNSceneDescription.swift}