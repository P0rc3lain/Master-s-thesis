...
\lstinputlisting[language=Swift, caption=Interfejs loadera tekstur]{code/PNTextureLoader.swift}
\subsection{Modele}
...
\lstinputlisting[language=Swift, caption=Interfejs loadera sceny]{code/PNSceneLoader.swift}
...
\lstinputlisting[language=Swift, caption=Interfejs loadera terenu]{code/PNTerrainLoader.swift}
