...
Przydatną między innymi do aktualizacji stanu animacji.
...
\lstinputlisting[language=Swift, caption=Interfejs bazowy dla obiektów w węzłach grafu sceny]{code/nodes/PNSceneNode.swift}