...
\lstinputlisting[language=Swift, caption=Węzeł obsługujący animacje]{code/nodes/PNAnimatedNode.swift}
...
\lstinputlisting[language=Swift, caption=Interfejs węzła kamery]{code/nodes/PNCameraNode.swift}
\subsubsection{Model}
...
\lstinputlisting[language=Swift, caption=Interfejs węzeła siatki]{code/nodes/PNMeshNode.swift}
...
\lstinputlisting[language=Swift, caption=Interfejs węzła siatki obsługującej animację szkieletową]{code/nodes/PNRiggedMeshNode.swift}
...
\lstinputlisting[language=Swift, caption=Interfejs węzła światła nadającego wpływ komponentu ambientowego]{code/nodes/PNAmbientLightNode.swift}
...
\lstinputlisting[language=Swift, caption=Interfejs węzła światła punktowego\, kierunkowego]{code/nodes/PNSpotLightNode.swift}
We wszystkich przypadkach interfejsy są zwięzłe i oczekują jedynie referencji do wybranego typu światła.
\lstinputlisting[language=Swift, caption=Interfejs węzła światła punktowego\, dookólnego]{code/nodes/PNOmniLightNode.swift}
...
\figh{images/pnengine/scene/particle.png}
     ...
     {fig:scene_particle}
     {4cm}
\lstinputlisting[language=Swift, caption=Interfejs węzła służącego do obsługi efektów cząsteczkowych]{code/nodes/PNParticleNode.swift}