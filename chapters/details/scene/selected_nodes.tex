...
\lstinputlisting[language=Swift, caption=Węzeł obsługujący animacje]
...
\lstinputlisting[language=Swift, caption=Interfejs węzła kamery]
...
\lstinputlisting[language=Swift, caption=Interfejs węzła światła punktowego\, kierunkowego]
...
\lstinputlisting[language=Swift, caption=Interfejs węzła światła punktowego\, dookólnego]
...
\figh{images/pnengine/scene/particle.png}
     ...
     {fig:scene-particle}
     {4cm}
\lstinputlisting[language=Swift, caption=Interfejs węzła służącego do obsługi efektów cząsteczkowych]
