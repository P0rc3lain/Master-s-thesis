...
\lstinputlisting[language=Swift, caption=Interfejs węzeła siatki]
...
\lstinputlisting[language=Swift, caption=Interfejs węzła siatki obsługującej animację szkieletową]
