...
Na dziedzińcu unosi się samolot, który posiada niebieski, jednolity odcień i charakteryzuje przezroczystością.
...
\figh{images/pnengine/rendering/lighting/lights-combined.jpg}
     {Klatki poddane wpływowi źródeł światła, ambientowe (lewa), kierunkowe (prawa)}
     {fig:pipeline-lights}
     {13cm}
