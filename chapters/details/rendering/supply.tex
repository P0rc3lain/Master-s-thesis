...
Wygenerowanie każdej klatki wymaga dwóch składowych.
Opisu sceny przypadającego na konkretną chwilę, w formie efektywnej do procesowania przez CPU.
Oprócz tego konieczne jest aby informacje wymagane do renderowania przeniesione zostały na GPU.
...
\lstinputlisting[language=Swift, caption=Struktura będąca informacją na bazie której klatka jest renderowana]
...
\lstinputlisting[language=Swift, caption=Struktura zawierająca maski dla renderowanych obiektów]
...
\lstinputlisting[language=Swift, caption=Interfejs skupiający w sobie niezmienniki dla danej klatki]
...
\lstinputlisting[language=Swift, caption=Struktura sceny w formie efektywnej do renderowania]
