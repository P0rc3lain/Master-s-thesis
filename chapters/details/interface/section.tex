...
\lstinputlisting[language=Swift, caption=Idea konfiguracji]{code/configuration/PNDefaults.swift}
\par
...
\lstinputlisting[language=Swift, caption=Konfiguracja silnika w kodzie klienckim]
