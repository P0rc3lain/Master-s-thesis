...
Biblioteka graficzna jest niezależna, natomiast gra szachowa, która posiada na niej zależność używa funkcjonalności podmodułów \eng{submodule}  w celu pobrania źródeł.
