...
Decyzja o wybraniu formy dystrybucji w postaci biblioteki wpłynęła na cele, które starano się osiągnąć.
...
Z tego względu zdecydowano się wprowadzić standard w odniesieniu do tworzonych plików i możliwie zachować go dla całego kodu źródłowego.
Sprawi to, że przeglądanie zawartości projektu wytworzy u czytelnika intuicję i ułatwi dalszą nawigację.
...
\lstinputlisting[language={Swift}, texcl=true, caption=Styl programistyczny na przykładzie struktury animacji]{code/animation/PNKeyframeAnimation.swift}
