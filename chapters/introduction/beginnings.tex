...
\section{Początki}
\figh{images/people/william-fetter.jpg}
     {William Fetter w momencie gdy pracował dla Boeing Aircraft, 1963}
     {fig:william-fetter}
     {6cm}
...
\figh{images/battlezone.jpg}
     {Battlezone, pierwsza produkcja wykorzystująca grafikę trójwymiarową, 1980}
     {fig:battlezone}
     {6cm}
...
\figh{images/toy-story.jpeg}
     {Klatka podglądu oraz finalna z filmu \q{Toy Story}, 1995}
     {fig:toy-story}
     {6cm}
