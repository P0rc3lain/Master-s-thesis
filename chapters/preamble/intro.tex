...
Największym wzrostem popularności wśród użytkowników uzyskują te operujące w ekosystemie Apple, między innymi ze względu na rewolucję, jaką przyniosły procesory z serii \textit{M} w 2020 roku.
...
Natywność w tym kontekście powinna odnosić się nie tylko do samej technologii, na której bazowano, ale także do podejścia architektonicznego do interfejsu biblioteki.
...
Wpasowującej się w okazjonalne renderowanie, ale odbiegającej od współczesnych standardów, które sam wdraża.
