...
Przez lata znajdowano kolejne zastosowania dla technologii, a wzrost mocy obliczeniowej sprzętu elektronicznego dodatkowo polepszał jej przystępność.
...
W tym kontekście produkt rozumiany powinien być jako biblioteka, pozwalająca za pomocą wysokopoziomowego interfejsu programistycznego na tworzenie animacji trójwymiarowych scen.
\par
Platformami stanowiącymi trzon uruchomieniowy dla technologii są Windows, Linux, macOS, a także mobilne Android oraz iOS.
W 2023 roku wśród ścisłej czołówki popularności wymienić można te operate o ekosystem Apple, między innymi ze względu na rewolucję, jaką zapoczątkowały procesory z serii \textit{M} w 2020 roku.
...
Dokładniejsza analiza pozwala jednak dostrzec, że w środowisku brakuje natywnej biblioteki, która byłaby w stanie posłużyć do tworzenia gier mobilnych, codziennych \eng{casual game}, a także trójwymiarowych wstawek do aplikacji użytkowych.
...
Obejmuje to konieczność wykorzystania odmiennego języka programowania od natywnego dla systemu, a także negatywnie wpływa na efektywność rozwoju kodu źródłowego przez wzgląd na potrzebę użycia mnogiej liczby środowisk programistycznych.
W przeciwnym razie niezbędne będzie skorzystanie z porzuconej przez producenta platformy alternatywy. 
