...
Weryfikacja możliwości i ocena użyteczności oparte zostały o refleksje powstałe podczas tworzenia gry szachowej, wykorzystującej uprzednio rozwiniętą bibliotekę.
\\
\par
...
The capabilities were verified and the usability was evaluated based on reflections that emerged during the creation of a chess game utilizing the developed library.
